...
var logger = require('appcan-logger')('[db][redis][index]');
 ...
 * @param callback
 */
redis.createConnection = function (callback) {
  var _this = this;
 ...
 * @param callback
 */
redis.openConnection = function (db, callback) {
 ...
 * @param callback
 */
redis.getConnect = function (dbName, callback) {
